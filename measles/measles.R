...
#' This document has its origins in the [SISMID short course on Simulation-based Inference](http://kingaa.github.io/sbied/measles/measles.html) given by Aaron King and Edward Ionides.
#' 
...
#' Note that we'll be making heavy use of the data-munging methods in packages **plyr** and **reshape2**, a [tutorial introduction to which is provided here](http://kingaa.github.io/R_Tutorial/hadley/munging.html).
#' Also, we'll be using **ggplot2** for plotting: see [this brief tutorial](http://kingaa.github.io/R_Tutorial/hadley/viz.html#a-more-systematic-approach-the-grammar-of-graphics).
#' Finally, we'll use the convenient **magrittr** syntax, which is explained [here](http://kingaa.github.io/R_Tutorial/hadley/munging.html#the-magrittr-syntax).
#' 
## ----prelims,cache=FALSE-------------------------------------------------
library(pomp)
library(plyr)
...
#' [A brief tutorial on these tools is provided here](http://kingaa.github.io/R_Tutorial/hadley/munging.html).
#' 
...
#' ## [**R** codes for this document](http://raw.githubusercontent.com/kingaa/clim-dis/master/measles/measles.R)
