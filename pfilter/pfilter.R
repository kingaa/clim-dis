...
#' This document has its origins in the [SISMID short course on Simulation-based Inference](https://kingaa.github.io/sbied/pfilter/pfilter.html) given by Aaron King and Edward Ionides.
#' 
