...
<div class="nb"> 
**Important Note:**
Note that the materials here use an old version of **pomp**.
With version 2, the **pomp** syntax changed substantially so that these codes will no longer run.
An up-to-date tutorial covering some of the same ground can be found [here](https://kingaa.github.io/sbied/).
</div>
